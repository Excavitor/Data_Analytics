...
class QueryFCusT1:
    ...
    def execute(self):
        ...
        div_q1 = """ select t.quarter, c.coustomer_key, sum(f.total_price) as total_price from ecomdb_star_schema.fact_table f
        ...
        cur.execute(div_q1)
        result = cur.fetchall()
        pd_data1 = pd.DataFrame(list(result), columns=["quarter","coustomer_key","total_sales"])
        ...
        return (
            ...
            pd_data3.to_dict(orient='records'), pd_data4.to_dict(orient='records')
        )
